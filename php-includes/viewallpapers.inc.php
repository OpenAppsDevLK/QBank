      ...
      <div class="modal-body">
                    ...
                    <div>
                     ...
                     <div>
                            ...
                            <input type="text" id="form-field-2" placeholder="(for your reference)" name="txt_pp_paper_name" value="" class="form-control limited " > 
                    </div>
          
                    <div>
                            <label style="padding-top: 10px;" for="form-field-2">Display Exam Name </label>
                            <input type="text" id="form-field-2" placeholder="(Ex: Enter Exam name)" name="txt_pp_question_paper_exam_name" value="" class="form-control limited " > 
                    </div>          

                    <div>
                            <label style="padding-top: 10px;" for="form-field-2">Subject Name </label>
                            <input type="text" id="form-field-2" placeholder="Enter Subject Name" name="txt_pp_question_paper_subj_name" value="" class="form-control limited " > 
                    </div> 

                     <div>
                            <label style="padding-top: 10px;" for="form-field-2">Grade | Class</label>
                            <input type="text" id="form-field-2" placeholder="" name="txt_pp_question_paper_grade" value="" class="form-control limited " > 
                    </div> 
                    ...
                    <div>
                            ...
                            <input type="text" id="form-field-3" name="txt_pp_question_paper_time" value="" placeholder="" class="form-control limited" >
                    </div>
...
>> Choose the correct / most suitable answer from the given answers (1), (2), (3), (4) for questions from 1 - 40.
                            </textarea>
                    </div>     
